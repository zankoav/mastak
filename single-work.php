...
?>
	...
	<div class="technology"
	     style="background-image:url(<?= $techno_bgp; ?>)">
				...
				<div class="technologies">
					<div class="container">
						<ul class="technologies__list"
						    ...
						    data-wrapper-color="linear-gradient(to right, <?= $color_list_start_m?>, <?= $color_list_end_m?>)">
							<?php foreach ( $techno_list as $item ) : ?>
								<li class="technologies__item">
									<span class="technologies__name"><?= $item; ?></span>
									<span class="technologies__addition
										<?= $techno_shape == 'circle' ? 'technologies__addition_circle' : ''; ?>"></span>
								</li>
							<?php endforeach; ?>
					</div>
				</div>
